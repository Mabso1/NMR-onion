...
def onion_lor(omega,tn,t,fs,y):
   ...
   # print(loss_current)
    ...
    optimizer=torch.optim.LBFGS(model.parameters(), lr=0.9, max_iter=20, tolerance_grad=1e-5, tolerance_change=1e-09, history_size=100, line_search_fn='strong_wolfe')
